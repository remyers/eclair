...
object Helpers {
  ...
  object Funding {
    ...
    def makeFirstCommitTxs(keyManager: ChannelKeyManager,
      ...
      makeArbitraryCommitTxs(keyManager, params,
        ...
        commitTxFeerate, fundingTxHash, fundingTxOutputIndex, remoteFirstPerCommitmentPoint, commitmentIndex = 0, Set.empty[DirectedHtlc])

    /**
     * This creates commitment transactions for both sides at an arbitrary `commitmentIndex` and
     * with (optional) `htlc` outputs.
     */
    def makeArbitraryCommitTxs(keyManager: ChannelKeyManager,
                               params: ChannelParams,
